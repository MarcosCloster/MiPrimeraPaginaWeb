    ...
    <main>
      ...
      <aside>
        ...
        <section id="izquierda">
          ...
          <h1 id="intro">Peliculas y Series:</h1>
...
<?php
        ...
        $select = "SELECT * FROM peliculas_proyecto";
...
?>
          ...
          <div class="foto">
            ...
            <a href='peliculas_info.php?id=<?php echo $id; ?>'>

            <img src="<?php echo $row['foto']?>">
        
            <div class="titulo"><h1><?php echo $row['titulo'] ?></h1></div>
...
<?php
        ...
        $select = "SELECT * FROM series_proyecto";
...
?>
          ...
          <div class="foto">
            ...
            <a href='series_info.php?id=<?php echo $id; ?>'>
