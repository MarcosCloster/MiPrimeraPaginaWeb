...
<html lang="en">
  ...
  echo "<div class='todo'><div class='tituloinfo'><b>" . $row['nombre'] . "</b><br></div>";

  echo "<br><br>" . "<img class='fotogrande' src='" . $row['foto'] . "'>" . "<br>";

  echo "<br><div class='cuadro'><div class='informacion'>" . $row['informacion'] . "</div><br>";

  echo "<br><div class='precio'>" . $row['precio'] . "</div></div><br>";
