...
<body>
    ...
    <?php
        ...
        if(isset($_POST["buscar"])&& isset($_POST["id"])&& !empty($_POST["id"])){
            ...
            $select = "SELECT * FROM musica_proyecto WHERE id = '$id'";
...
<div id="todo">
    ...
    <form action="form_eliminar_musica.php" method="post">

        <h2>Ingrese el ID de la musica que desea eliminar</h2>

        <label for="id">Id de la musica: </label>
        ...
        <table class="tabla">
            ...
            <tr>
                ...
                <td><a class="linkDeEliminar" href="eliminar_musica.php?id=<?php echo $row["id"]; ?>">Eliminar</a></td>
