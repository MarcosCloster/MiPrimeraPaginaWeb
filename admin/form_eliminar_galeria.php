...
<div id="todo">
    ...
    <form action="form_eliminar_galeria.php" method="post">

        <h2>Ingrese el ID de la imagen que desea actualizar</h2>

        <label for="id">Id de la imagen: </label>
        <input type="text" value="<?php if(isset($_POST["buscar"])&& isset($_POST["id"])&& !empty($_POST["id"])){echo $row["id"];}else {echo "";} ?>" name="id" id="id" placeholder=".../.../...">
        ...
        <table class="tabla">
            ...
            <tr>
                ...
                <td><a class="linkDeEliminar" href="eliminar_galeria.php?id=<?php echo $row["id"]; ?>">Eliminar</a></td>
